...
*//** @file
@brief      Implementation of the firmware routines in BootROM available to user.
******************************************************************************/
#include <XMC1300.h>
...
/**************************************************************************//**
Purpose:        Implemetation of fast square root algorithm after Otto Peter's 
                (Otto Peter: Prozessor zieht Wurzel, c't 1990, Heft 1, page 300-306)
...
/**************************************************************************//**
Purpose:        Implemetation of CalcTemperature function
...
uint32_t XMC1000_CalcTemperature(void)
{
    ...
    /** Check the lower limit, if bellow use configANATSEMON_min as reference value */
...
/**************************************************************************//**
Purpose:        Implemetation of TIMM1_CalcTSEVAR function
...
uint32_t XMC1000_CalcTSEVAR(uint32_t temperature)
{
    ...
    /* Lookup for the TSE sensor value coresponding to the real temperature; if nothing is found, use the user value. */
