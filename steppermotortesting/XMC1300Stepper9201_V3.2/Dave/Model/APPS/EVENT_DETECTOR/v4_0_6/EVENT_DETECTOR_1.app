...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="EVENT_DETECTOR" URI="http://resources/4.0.6/app/EVENT_DETECTOR/1" description="Provides the configuration for Event Request Source &#xA;and Event Trigger Logic units of ERU" version="4.0.6" minDaveVersion="4.0.0" instanceLabel="CMPSin_AND_GateTimeCos" appLabel="">
  ...
  <virtualSignals name="signal_a" URI="http://resources/4.0.6/app/EVENT_DETECTOR/1/vs_event_detector_input_A" hwSignal="a" hwResource="//@hwResources.0" visible="true">
    <upwardMapList xsi:type="ResourceModel:Connections" href="../../ACMP_CONFIG/v4_1_2/ACMP_CONFIG_1.app#//@connections.0"/>
  </virtualSignals>
  ...
  <connections URI="http://resources/4.0.6/app/EVENT_DETECTOR/1/http://resources/4.0.6/app/EVENT_DETECTOR/1/vs_event_detector_FlagStatus/http://resources/4.1.14/app/EVENT_GENERATOR/1/vs_event_generator_pdin" sourceSignal="status" targetSignal="pattern" srcVirtualSignal="//@virtualSignals.3">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="../../EVENT_GENERATOR/v4_1_14/EVENT_GENERATOR_1.app#//@virtualSignals.0"/>
    <targetVirtualSignal href="../../EVENT_GENERATOR/v4_1_14/EVENT_GENERATOR_1.app#//@virtualSignals.0"/>
  </connections>
