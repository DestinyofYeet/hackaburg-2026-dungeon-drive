...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PWM_CCU4" URI="http://resources/4.1.18/app/PWM_CCU4/2" description="PWM APP using one timer slice of CCU4, with external events support, to generate a PWM output." mode="NOTSHARABLE" version="4.1.18" minDaveVersion="4.0.0" instanceLabel="NoiseBlankSin" appLabel="" containingProxySignal="true">
  ...
  <virtualSignals name="ext_event0" URI="http://resources/4.1.18/app/PWM_CCU4/2/vs_ccu4_cc4_gp0_unsync" hwSignal="gp0_unsync" hwResource="//@hwResources.0" visible="true">
    <upwardMapList xsi:type="ResourceModel:Connections" href="../../DIGITAL_IO/v4_0_16/DIGITAL_IO_9.app#//@connections.2"/>
  </virtualSignals>
  ...
  <hwResources name="CC4 Config" URI="http://resources/4.1.18/app/PWM_CCU4/2/hwres_ccu4_cc4_slice" resourceGroupUri="peripheral/ccu4/*/cc4/*" mResGrpUri="peripheral/ccu4/*/cc4/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/CCU40/CCU40_0.dd#//@provided.37"/>
  </hwResources>
  ...
  <hwResources name="PWM_CCU4 Channel Out" URI="http://resources/4.1.18/app/PWM_CCU4/2/__pin_hwres_port_channel_out" resourceGroupUri="devicepackage/0/8" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
